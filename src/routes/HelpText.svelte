<script lang="ts">
    ...
    let info_trigger: HTMLSpanElement;
...
<span class="w-fit flex gap-2 select-none" on:mouseover={() => {is_active = true}} on:mouseout={() => {is_active = false}} bind:this={info_trigger}>
