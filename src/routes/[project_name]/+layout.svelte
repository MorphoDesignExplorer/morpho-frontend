...
<div class="main-grid font-sans">
    ...
    >
        ...
        <div class="flex">
            <a
                href="{base}/{$page.params.project_name}/"
            ...
            <a
                href="{base}/{$page.params.project_name}/about"
                class="flex items-center gap-2 bg-white border border-gray-200 shadow-sm text-blue-500 px-3 py-1 hover:bg-blue-500 hover:text-white transition-colors ease-in-out font-normal"
                class:rounded-r-lg={data.authentication_status.status !==
                    "VERIFIED"}
            >
                <svg
                    xmlns="http://www.w3.org/2000/svg"
            ...
            {#if data.authentication_status.status === "VERIFIED"}
                <a
                    href="{base}/{$page.params.project_name}/configure"
                    class="flex items-center gap-2 bg-white border border-gray-200 shadow-sm rounded-lg rounded-l-none text-blue-500 px-3 py-1 hover:bg-blue-500 hover:text-white transition-colors ease-in-out font-normal"
                >
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 24 24"
