...
<div class="main-grid font-sans">
    ...
    <div id="navbar" class="p-4 flex items-center text-lg font-extrabold gap-3 bg-blue-500 text-white">
        ...
        <div class="flex">
            <a href="/{$page.params.project_name}/" class="flex items-center gap-2 bg-white border border-gray-200 shadow-sm rounded-lg rounded-r-none text-blue-500 px-3 py-1 hover:bg-blue-500 hover:text-white transition-colors ease-in-out font-normal">
            ...
            <a href="/{$page.params.project_name}/about" class="flex items-center gap-2 bg-white border border-gray-200 shadow-sm text-blue-500 px-3 py-1 hover:bg-blue-500 hover:text-white transition-colors ease-in-out font-normal" class:rounded-r-lg={data.authetication_status.status !== "VERIFIED"}>
            ...
            <a href="/{$page.params.project_name}/configure" class="flex items-center gap-2 bg-white border border-gray-200 shadow-sm rounded-lg rounded-l-none text-blue-500 px-3 py-1 hover:bg-blue-500 hover:text-white transition-colors ease-in-out font-normal">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
        ...
        {:else}
            <a href="/auth/login/?redirect={$page.url.pathname}" class="bg-white border border-gray-200 shadow-sm rounded-lg text-blue-500 px-3 py-1 hover:bg-blue-500 hover:text-white transition-colors ease-in-out items-center">Login</a>
        {/if}
    </div>
</div>
<!-- Navbar End -->
