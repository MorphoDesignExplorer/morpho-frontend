...
type RouteParams = { project_name: string };
type RouteId = '/[project_name]';
...
type LayoutRouteId = RouteId | "/[project_name]" | "/[project_name]/about"
type LayoutParams = RouteParams & { project_name?: string }
